...
public class CordovaSimLaunchConstants {
	...
	public static final String FH_LAUNCH_CONFIGURATION_ID = "org.jboss.tools.vpe.cordovasim.eclipse.FeedHenryLaunchConfigurationType"; //$NON-NLS-1$
...
//	public static final String START_PAGE = Activator.PLUGIN_ID + ".START_PAGE"; //$NON-NLS-1$
	...
	public static final String FH_LOCAL_SERVER_URL = Activator.PLUGIN_ID + ".FH_LOCAL_SERVER_URL"; //$NON-NLS-1$
}
